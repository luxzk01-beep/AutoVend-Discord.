...
class Store(commands.Cog):
    ...
    @app_commands.describe(
        ...
        price="Preço", 
        delivery_content="O que será enviado automaticamente", 
    ...
    @is_admin()
    async def adicionar_produto(self, interaction: discord.Interaction, name: str, category: str, description: str, price: float, delivery_content: str, image_url: str):
        await interaction.response.defer(thinking=True, ephemeral=True)
        try:
            data_to_insert = {
                "name": name,
